...
2026-09-23四张纯文字原创居民候选取得真RGBA与四底/144px首轮检查；[审查](../art/candidates/npc_river_residents_v001/REVIEW.md)暂列河狸A为下一轮方向、乌龟D为备选。A仍偏直立写实和相机偏低，B偏动物肖像，C在游戏尺寸细腿/配件难读，D有隐藏足且低体态与主角接近。尚无第二轮、独立批准、四方向母图、编辑源或动画/GPU角色正式尺度；不得把四物种当一只NPC的四方向。以A原图为唯一改稿父源做定向第二轮，完成解剖/色板/道具和实景动态质量门后才可关闭；关系、日程与故事线另按后续Stage实现。
