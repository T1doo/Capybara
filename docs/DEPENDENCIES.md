...
- Blender：当前未安装。已核验官方 Blender 4.5.13 LTS Windows x64 Portable ZIP（约 380 MB）与 SHA-256 `b5fdf800ce65fa2f209e8f68d02667e4d720fa1c42f247c72d1882ab04decba6`，但二进制下载因缺少本轮明确授权被安全层拒绝；未下载、未解压、未写入 `D:\GameDev`。
...
|---|---|---|---|---|
| Blender Portable | 4.5.13 LTS | `https://download.blender.org/release/Blender4.5/blender-4.5.13-windows-x64.zip` | Stage 3 正交预渲染与 cutout 对比 | 未安装；安全层要求用户对约 380 MB 外部二进制下载明确授权 |
