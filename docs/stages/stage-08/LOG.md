...
## 2026-09-16T15:35:34+08:00 · DOC-MIGRATE-stage-08 · 阶段记录迁移
...
- 历史任务 `CAP-0410`：原状态 `todo`，原阶段 `8`；按 v2 Stage 8 执行。

- 历史任务 `CAP-0411`：原状态 `todo`，原阶段 `8`；按 v2 Stage 8 执行。

- 历史任务 `CAP-0420`：原状态 `todo`，原阶段 `8`；按 v2 Stage 8 执行。

- 历史任务 `CAP-0421`：原状态 `todo`，原阶段 `8`；作为 Stage 8 质量样板。

- 历史任务 `CAP-0422`：原状态 `todo`，原阶段 `8`；作为 Stage 8 质量样板。
