...
## 2026-09-16T15:35:34+08:00 · DOC-MIGRATE-stage-11 · 阶段记录迁移
...
- 历史任务 `CAP-0540`：原状态 `todo`，原阶段 `3`；视觉样板与垂直切片分批测试。

- 历史任务 `AUT-1100`：原状态 `todo`，原阶段 `11`；原清单无附加记录。

- 历史任务 `AUT-1101`：原状态 `todo`，原阶段 `11`；原清单无附加记录。
